    ...
    <div className="flex min-h-screen items-center justify-center bg-ink-950 px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 style={{ fontFamily: 'var(--font-brand)' }} className="text-xl font-semibold text-white">Mira Vue</h1>
          <p className="mt-1 text-sm text-slate-500">Competitive and market intelligence for founders</p>
        </div>
        {children}
      </div>
    </div>
